...
class Procurement extends PackageManagement implements ContractsProcurement
{
    ...
    public function showUsingRelation(): array{
        return [
            'transaction','warehouse','author','funding','supplier',
